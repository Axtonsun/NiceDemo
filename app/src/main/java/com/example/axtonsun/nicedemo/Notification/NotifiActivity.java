package com.example.axtonsun.nicedemo.Notification;
...
/**
 * Created by AxtonSun on 2016/12/8.
 */
...
public class NotifiActivity extends AppCompatActivity {
    ...
    public void basicNotify(View view) {
        ...
        // 构造PendingIntent 完成延迟操作(只需在普通的Intent的基础上包装一层)
    ...
    public void collapsedNotify(View view) {
        ...
        RemoteViews contentView =
                new RemoteViews(getPackageName(),
                        R.layout.notification);// layout===> notification
    ...
    public void headsupNotify(View view) {
        ...
        push.setClass(this, NotifiActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(
